...
public class MySQLConnectionTest {
    ...
    static final String URL = "jdbc:mysql://tecc.anyro.com:3306/ein_lee?allowPublicKeyRetrieval=true&useSSL=false";
    static final String USERNAME = "ein_lee";
    static final String PASSWORD = "#db_ein_lee#";
